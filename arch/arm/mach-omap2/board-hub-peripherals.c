...
#include "lge/lge_diag_communication.h"
#endif
		...
		struct kobj_attribute *attr, char *buf)
{
	/* Dimensions, 80x80, y starts at 830
	   center: x: home: 75, menu: 185, back: 295, search 405, y: 900 */
	return sprintf(buf,
			__stringify(EV_KEY) ":" __stringify(KEY_HOME)  ":75:900:110:140"
			":" __stringify(EV_KEY) ":" __stringify(KEY_MENU)   ":185:900:110:140"
...
static struct gpio_h2w_platform_data hub_headset_data = {
           .gpio_detect = 170,
           .gpio_button_detect = 163,
           .gpio_jpole = 164,
           .gpio_mic_bias_en = 60,
...
static struct platform_device lge_hub_headset_device = {
           ...
           .id = -1,
           .dev = {
                     .platform_data = &hub_headset_data,
           },
};
#else //jungsoo1221.lee [LGE_US850_HEADSET_END]
...
static struct spi_board_info hub_ipc_spi_board_info[] __initdata = {
...
#endif
	{
		...
		.max_speed_hz = 12000000, /* 20110807 dongyu.gwak@lge.com SPI 12Mhz */
//		.max_speed_hz = 24000000,
#else
		.max_speed_hz = 24000000,
#endif
...
{
	spi_register_board_info(hub_ipc_spi_board_info, 
			ARRAY_SIZE(hub_ipc_spi_board_info));
}
#endif /* CONFIG_LGE_SPI */
