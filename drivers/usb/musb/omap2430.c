...
EXPORT_SYMBOL(SAVE_MUSB_ADDRESS_FOR_LGMUSB_P);
...
// LGE_UPDATE_S 20110424 [jaejoong.kim@lge.com] Do Force Standby - sync with P970
	 ...
	 */
// LGE_UPDATE_E 20110424 [jaejoong.kim@lge.com] Do Force Standby - sync with P970
